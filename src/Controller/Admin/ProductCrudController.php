...
class ProductCrudController extends AbstractCrudController
{
    ...
    {
        return [
            yield ImageField::new('illustration', 'Illustration')->setBasePath('uploads/')->setUploadDir('public/uploads/')->setUploadedFileNamePattern('[year]-[month]-[day]-[slug].[extension]'),
